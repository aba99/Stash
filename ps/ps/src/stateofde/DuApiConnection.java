...
private MuControl getMuControl_branch (ArrayList<SessionAtom> trailer_to_header_branch)
   ...
   public void getParentOfUpr(String sessname,String currentUprName )
   {
   	try {					    		   		
   	            Session obj = this.getSession(sessname);
   ...
   protected  String getParentName(SessionAtom atom,String currentUprName)
   {
	   	if (atom.getData()!=null && !currentUprName.trim().isEmpty()) 
	   	{
	   				...
	   				if (atom.getData().getUprocName().equalsIgnoreCase(currentUprName))
	   				{
	   							...
	   							{
	   								return atom.getParent().getData().getUprocName();
	   							}
	   							else
	   							{
	   								return "NO_PARENT";
...
public void readSession(Session session) throws UniverseException
{
    ...
    public String getUprocDepsAndVariablesToString(String uproc)
	{//this was developed for the state of DE
    	...
    	{
    		return "UPROC NOT FOUND ON "+this.getConnName();
    	}
