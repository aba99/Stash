...
public class Refresh_OptTsk_Rule {
	    ...
	    private static void connect(String connectFile)
	    {
			...
			/// Reading connectFile info
					...
					for(int i=0;i<nodes.length;i++)
					{
						...
						DuApiConnection conn= new DuApiConnection(nodes[i], config_params.get("AREA"),config_params.get("HOST"),Integer.parseInt(config_params.get("PORT")),config_params.get("USER"),config_params.get("PASSWORD"),false,false,true);
